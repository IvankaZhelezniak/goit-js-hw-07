...
const creatImg = img => { 
  return `
  <li>
   <img  src='${img.url}' alt='${img.alt}' width=400 />
  </li>
  `;
};

console.log(creatImg(images[0]));

const makeGalleryImg = images.map(creatImg).join(' ');
console.log(makeGalleryImg);

galleryEl.insertAdjacentHTML('afterbegin', makeGalleryImg);
